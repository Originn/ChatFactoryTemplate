...
export default function PrivacyPolicy() {
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 2, sm: 4 } }}>
      ...
      >
        Privacy Policy for {config.productName} ChatBot
      </Typography>
      <Typography 
        variant="h6" 
        component="h2" 
      ...
      >Data Retention and Deletion</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
      ...
      >Data Sharing and Third-Party Disclosure</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
      ...
      >Legal Basis for Processing (GDPR)</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
      ...
      >User Rights Under GDPR</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
      ...
      >International Data Transfers</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
      ...
      >Cookies and Similar Technologies</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
      ...
      >Contact Information and Complaints</Typography>
      <Typography 
        paragraph
        sx={{
          fontSize: { xs: '0.875rem', sm: '1rem' },
